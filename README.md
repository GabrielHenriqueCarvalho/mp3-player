...
# o que usa
* usei a biblioteca pygame pra tocar o áudio e tkinter para interface
* usar pygame provavelmente não foi a melhor ideia por ser uma biblioteca de jogos

# como baixar
* todas as bibliotecas usadas estão no requirements.txt para baixar pelo terminal
